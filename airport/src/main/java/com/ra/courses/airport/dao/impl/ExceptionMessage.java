...
public enum ExceptionMessage {
    ...
    FAILED_TO_UPDATE_PLANE("Failed to update plane with id "),
    FAILED_TO_DELETE_PLANE("Failed to delete plane with id "),
    FAILED_TO_GET_PLANE("Failed to get plane with id "),
